...
_DARK = {
    ...
    "bg_feedback_pos_hover": "#1f4a35",
    "bg_feedback_neg": "#3a1a1a",
    "bg_feedback_warn": "#3a3010",
    "bg_feedback_warn_hover": "#4a3d16",
    "border_feedback_pos": "#2a5a3a",
    "border_feedback_neg": "#5a2a2a",
    "border_feedback_warn": "#4a3a1a",
    "bg_diff_add": "#1a3a1a",
    "bg_diff_del": "#3a1a1a",
    # Text
    "text_primary": "#d4d4d4",
    ...
    "syn_builtin": "#4ec9b0",
    "syn_keyword2": "#c586c0",
    "text_on_success_muted": "#0a1512",
    "accent_success_muted_hover": "#6fe0c8",
    # Git status
    "git_added": "#73c991",
    "git_modified": "#e2c08d",
    "git_deleted": "#c74e39",
...
_LIGHT = {
    ...
    "bg_feedback_pos_hover": "#c8e6c9",
    "bg_feedback_neg": "#fce4ec",
    "bg_feedback_warn": "#fff8e1",
    "bg_feedback_warn_hover": "#ffecb3",
    "border_feedback_pos": "#a5d6a7",
    "border_feedback_neg": "#f8bbd0",
    "border_feedback_warn": "#ffe082",
    "bg_diff_add": "#e6ffe6",
    "bg_diff_del": "#ffe6e6",
    # Text
    "text_primary": "#333333",
    ...
    "syn_builtin": "#267f99",
    "syn_keyword2": "#af00db",
    "text_on_success_muted": "#ffffff",
    "accent_success_muted_hover": "#256b5e",
    # Git status
    "git_added": "#22863a",
    "git_modified": "#b08800",
    "git_deleted": "#cb2431",
    "git_untracked": "#6e6e6e",
    # Severity
    "severity_critical": "#d32f2f",
    "severity_high": "#e65100",
    "severity_medium": "#1565c0",
    "severity_low": "#2e7d32",
    "severity_info": "#6e6e6e",
    # Plan status
    "plan_pending": "#767676",
